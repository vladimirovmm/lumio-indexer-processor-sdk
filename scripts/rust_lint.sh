...
# This script runs linting for both the examples and lumio-indexer-processors-sdk directories
...
echo "\nLinting lumio-indexer-processors-sdk directory..."
run_lint "lumio-indexer-processors-sdk"
